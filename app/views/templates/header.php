    ...
    <div class="mobile-nav" id="mobileNav">
        <div class="mobile-nav-content">
            ...
            <nav class="mobile-nav-links">
                ...
                <a href="public/index.php?r=lists/index" class="mobile-nav-link">
                ...
                <nav class="custom-navbar">
                    ...
                    <div class="nav-section">
                        <nav class="main-nav">
                            ...
                            <a href="public/index.php?r=lists/index" class="nav-link">
                                <i class="bi bi-list-check"></i>
                                <span>Mes listes</span>
                            </a>
                            ...
                            <a href="#" class="nav-link">
                                ...
                                <span>FAQs</span>
                                <?php
                                // ARCHIVÉ: ce fichier n'est plus utilisé. Le header est sous app/views/layouts/partials/header.php
                                ?>
